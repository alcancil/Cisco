...
🔍 Por Que Usar Ambientes Virtuais?
    ...
    Isolar Dependências
        ...
        Evita que bibliotecas de um projeto (ex: telnetlib v1.0) conflitem com as de outro (ex: telnetlib v2.0).

    Reproducibilidade

        Garante que seu código funcione em qualquer máquina (com as mesmas versões de bibliotecas).

    Sem Poluir o Python Global

        Instalações ficam restritas ao ambiente do projeto, sem afetar o sistema.
