...
![TABELA](Imagens/02-tabela_qos.png "Fonte: Internet sem especificação de autoria") {.text-left} <br></br>
![TABELA](Imagens/03-tabela_qos_02.png "Fonte: Internet sem especificação de autoria") {.text-left} <br></br>
