...
flowchart TD
    ...
    %% --- Estilos ---
    classDef host fill:#cce5ff,stroke:#004085,stroke-width:10px,color:#000,font-weight:bold;
    classDef switch fill:#e6ccff,stroke:#5a0085,stroke-width:200px,color:#000,font-weight:bold;
    classDef router fill:#d4edda,stroke:#155724,stroke-width:100px,color:#000,font-weight:bold;
```
